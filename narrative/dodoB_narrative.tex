...
to date.  However, the linkages that would crucially support
re-integration of these data are in nearly all cases missing, which
...
interoperate. \textbf{We will build a proof-of-concept platform that
  ...
  modeling frameworks, such as those discussed below}. The outcome
will be a scalable model knowledgebase that crosscuts and connects all
...
\centering
  ...
  \begin{tabular}{|ll|M{\dc}|M{\dc}|M{\dc}|M{\dc}|M{\dc}|M{\dc}|}
    ...
    \cline{3-8}
    Amazonia & Plants & \yes & \yes & \yes & \yes & \planned & \yes \\
    \cline{3-8}
